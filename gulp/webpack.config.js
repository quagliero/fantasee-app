...
var srcPath = path.join(process.cwd(), pkg.src.js);
...
var webpackSettings = {
    ...
    entry: {
        ...
        'add-league': [ path.join(srcPath, 'add-league.js') ],
        'counter': [ path.join(srcPath, 'counter.js') ],
        'table-sortable': [ path.join(srcPath, 'table-sortable.js') ],
